...
const uint8_t MAX_DROPS = 42;
const uint8_t MAX_TRAIL = 12;
const uint8_t MAX_FAST = 17;

const uint8_t SPAWN_CHANCE = 55;      // chance to spawn a crawling drop
const uint8_t SPAWN_FAST_CHANCE = 29; // chance to spawn a fast drop
